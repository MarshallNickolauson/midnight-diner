...
const MoodSection = () => {
    return (
        <section className='bg-mainBlack pb-16'>
            ...
            <div className='flex flex-col lg:flex-row justify-center space-x-4 text-mainWhite'>

                <div className='flex flex-row justify-center items-center space-x-6 p-4 text-right'>
                ...
                <div className='border-r-2 border-mainWhite hidden lg:block'></div>

                <div className='flex flex-row justify-center items-center space-x-6 p-4 text-left'>
