...
const YellowButtonHollow = ({ text = 'blank', navigateTo = '/', width = '150' }) => {
  ...
  return (
    <div
      ...
      className="bg-mainBlack hover:bg-mainYellow hover:border-mainYellow-500 hover:text-mainYellow cursor-pointer border-4 border-mainYellow transition-all duration-200 ease-in-out group"
    >
