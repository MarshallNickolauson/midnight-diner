...
const YellowButtonFilled = ({ text = 'blank', navigateTo = '/', width = '150' }) => {
  ...
  return (
    <div
      ...
      className="bg-mainYellow hover:bg-transparent hover:border-mainYellow-500 hover:text-mainYellow cursor-pointer border-4 border-mainYellow transition-all duration-300 ease-in-out group"
    >
